...
namespace Bugsnag.NetCore.Test.FunctionalTests
{
    /// <summary>
    ...
    public static class StaticData
    {
        ...
        public static readonly Exception TestCreatedException;
        ...
        static StaticData()
        {
            ...
            TestCreatedException = new Exception("System Test Exception");
